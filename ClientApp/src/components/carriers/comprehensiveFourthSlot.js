...
class ComprehensiveFourthSlot extends React.Component{
    constructor(props)
    {
        super(props);
    ...
    onComprehensiveFourthSlotClick=()=>{
    ...
    render()
    {
        return(
                ...
                <div>
                <svg witdth={100} height={100} viewBox={'0 0 100 100'}  onClick={this.onComprehensiveFourthSlotClick}>
                ...
                <text width="100">
                <textPath xlinkHref="#firstPath" startOffset={156} fill={this.state.annotation.fill}>
...
export default connect()(ComprehensiveFourthSlot)